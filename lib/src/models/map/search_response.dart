...
SearchMapResponse searchMapResponseFromJson(String str) =>
    SearchMapResponse.fromJson(json.decode(str));

String searchMapResponseToJson(SearchMapResponse data) =>
...
class SearchMapResponse {
  ...
  factory SearchMapResponse.fromJson(Map<String, dynamic> json) =>
      SearchMapResponse(
        type: json["type"],
